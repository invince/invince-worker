...
import io.github.invince.exception.TaskCancelled;
import io.github.invince.exception.WorkerWarning;
...
class AbstractSyncWorkerPool<T extends BaseTask<SingleResult>, GroupByType, SingleResult>
    ...
    protected void beforeInit() {
        ...
        requestTaskMap = config.getHelper().newTaskGroups(config.getQueueName());
    }
